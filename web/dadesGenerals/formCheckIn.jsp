...
<!--       <link type="text/css" rel="stylesheet" href="css/materialize.min.css" media="screen"/> -->
    ...
    <body class="bodyColor lletra">
        <div class="w3-container titolCheck ">
            <h1 class="marge">Check-In</h1>
        </div>
                <section>
                    <div class="w3-content lletraForm">
                    <div class="w3-row-padding">
                        ...
                        <div class="w3-quarter"><b>Observacions: </b>${habitacio.observacions}</div> 
                         ...
                         <section class="">
                      <div class="w3-content  w3-white sombra rodo">
                   <form action="<c:url value='dadesGestio'/>" method="post" id="altaClient" class="w3-container margeAll">
                      <input type="hidden" name="opcio" value="altaEstancia"/>
                      <input type="hidden" name="numHab" value="${habitacio.numero}"/>

                        <div class="w3-row marginBaix w3-text-indigo">
                            <h2>Formulari Alta Client</h2>
                           </div> 
                      <div class="paddingALL">
                     <div class="w3-row-padding w3-section w3-text-grey">
                                <div class="w3-half">
<!--                                     <label>Nom*:</label>-->
                                <input type="text" name="nom" class="w3-input w3-text-black" id="nom" required placeholder="Nom*"/>
                                </div>
                                <div class="w3-half">
<!--                                    <label>1er Llinatge*:</label>-->
                      ...
                      <div class="paddingALL">
                       <div class="w3-row-padding w3-section paddingALL w3-text-grey">
                                <div class="w3-half">
<!--                                  <label>2º Llinatge:</label>-->
                                     <input tyep="text" name="cognom2" class="w3-input" id="congnom2" placeholder="2ºLlinatge">
                                </div>
                                 <div class="w3-half">
                                    <select required name="nacionalitat" class="w3-select w3-text-grey" id="nacionalitat">
                                        <option value="" disabled selected class="w3-text-grey">Nacionalitat*:</option>
                                        <c:forEach var="llista" items="${llistaNac}">
                                            
                                            <option value="${llista.idNacionalitat}" <c:if test="${llista.idNacionalitat == '107'}">selected</c:if>>${llista.nacionalitat}</option>
                                        </c:forEach>
                                    </select>
                                </div>
                       </div>
                      ...
                      <div class="w3-row-padding w3-section paddingALL w3-text-grey">
                          <div class="w3-half">
                                    <label class="w3-text-grey">Data Naixement*:</label>
                      ...
                      <div class="paddingALL">
                           <div class="w3-row-padding w3-section paddingALL">
                                <div class="w3-half">
                                    <select required name="tipoDocument" class="w3-select w3-text-grey" id="tipoDoc">
...
<!--                                    <label>Núm. Document*:</label>-->
                      ...
                      <div class="paddingALL marginBaixPlus">
                      <div class="w3-row-padding w3-section paddingALL">
                                <div class="w3-half">
